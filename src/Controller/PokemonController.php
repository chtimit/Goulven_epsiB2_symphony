...
class PokemonController extends AbstractController
{
    ...
    /**
     * @Route("/id/{id}", name="pokemon_show", methods={"GET"})
     */
    ...
    {
        $pokemons = $this->getDoctrine()->getRepository(Pokemon::class)->findByType($type);

        return $this->render('pokemon/showType.html.twig', ['showType'=>$pokemons]);
    }
