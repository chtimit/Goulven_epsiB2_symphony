 ...
 */
class ATK extends \App\Entity\ATK implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\ATK' . "\0" . 'id', '' . "\0" . 'App\\Entity\\ATK' . "\0" . 'Name', '' . "\0" . 'App\\Entity\\ATK' . "\0" . 'PWR', '' . "\0" . 'App\\Entity\\ATK' . "\0" . 'Type'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ATK $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setName(string $Name): \App\Entity\ATK
    {
    ...
    public function getPWR(): ?int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPWR', []);
     ...
     * {@inheritDoc}
     */
    public function setPWR(int $PWR): \App\Entity\ATK
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPWR', [$PWR]);
     ...
     * {@inheritDoc}
     */
    public function setType(int $Type): \App\Entity\ATK
    {
