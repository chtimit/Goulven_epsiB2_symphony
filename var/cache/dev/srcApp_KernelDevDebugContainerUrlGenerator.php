...
class srcApp_KernelDevDebugContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'bag_index' => [[], ['_controller' => 'App\\Controller\\BagController::index'], [], [['text', '/bag/']], [], []],
        'bag_show' => [['id'], ['_controller' => 'App\\Controller\\BagController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/bag/id']], [], []],
        ...
        'pokemon_show' => [['id'], ['_controller' => 'App\\Controller\\PokemonController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/pokemon/id']], [], []],
        'pokemon_showType' => [['type'], ['_controller' => 'App\\Controller\\PokemonController::showType'], [], [['variable', '/', '[^/]++', 'type', true], ['text', '/pokemon/type']], [], []],
        ...
        'starter_index' => [[], ['_controller' => 'App\\Controller\\StarterController::index'], [], [['text', '/starter/']], [], []],
