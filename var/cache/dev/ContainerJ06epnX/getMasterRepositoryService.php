...
// Returns the private 'App\Repository\MasterRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\MasterRepository.php';

return $this->privates['App\Repository\MasterRepository'] = new \App\Repository\MasterRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
