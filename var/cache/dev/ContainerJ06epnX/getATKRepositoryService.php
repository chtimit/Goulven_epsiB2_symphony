...
// Returns the private 'App\Repository\ATKRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ATKRepository.php';

return $this->privates['App\Repository\ATKRepository'] = new \App\Repository\ATKRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
