...
// Returns the private 'App\Repository\SointRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SointRepository.php';

return $this->privates['App\Repository\SointRepository'] = new \App\Repository\SointRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
