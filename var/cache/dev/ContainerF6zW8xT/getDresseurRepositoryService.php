...
// Returns the private 'App\Repository\DresseurRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DresseurRepository.php';

return $this->privates['App\Repository\DresseurRepository'] = new \App\Repository\DresseurRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
